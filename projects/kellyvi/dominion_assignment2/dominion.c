...
int playAdventurer(int currentPlayer, int drawntreasure, int temphand[MAX_HAND], int z, struct gameState *state){
...
int playGreat_Hall(int currentPlayer, int handPos, struct gameState *state) {
  //+1 Card
  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      playAdventurer(currentPlayer, drawntreasure, temphand, z, state);
